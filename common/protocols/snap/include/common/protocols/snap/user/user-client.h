...
typedef vs_status_e (*vs_snap_user_state_notif_cb_t)(vs_status_e res, const vs_mac_addr_t *mac, const char *json);

typedef struct {
    vs_snap_user_state_notif_cb_t device_state_update; /**< Current state notification */
} vs_snap_user_client_service_t;
