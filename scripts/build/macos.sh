...
pushd "${SCRIPT_FOLDER}/../../"
    ...
    pushd ${BUILD_DIR}
        ...
        cmake -DKS_PLATFORM="macos" -DBUILD_SERVICE_ENABLE=OFF -DCMAKE_PREFIX_PATH=/Users/kutashenko/Qt/5.14.2/clang_64 -DVS_MACOS_IDENT="7FD87844FA13BF5FCA51E9D32D0829BA632BF1EC" ..
