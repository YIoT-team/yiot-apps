...
build_arch() {
	...
	cmake -DCMAKE_BUILD_TYPE="Debug" -DKS_PLATFORM="android" -DANDROID_PLATFORM=33 -DANDROID_QT=ON -DANDROID_ABI="${PARAM_ABI}" ../..
	make yiot
    popd
}
...
build_apk() {
	...
	cmake -DCMAKE_BUILD_TYPE="Debug" -DKS_PLATFORM="android" -DANDROID_PLATFORM=33 -DANDROID_QT=ON \
